...
/**
 * The interface that Sequelize uses to talk with DBISAM database
 */
class DBISAMQueryInterface extends QueryInterface {
  /**
   * A wrapper that fixes inability to cleanly remove columns from existing tables if they have a foreign key constraint. (Unnecessary?)
   *
   * @override
   */
...
exports.DBISAMQueryInterface = DBISAMQueryInterface;
